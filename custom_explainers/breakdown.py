...
class _ExplainerDirection:
    Up = "up"
    Down = "down"

class _Explanation:
    def __init__(self, var_names, var_values, contributions, direction):
        self.var_names = var_names
        self.var_values = var_values
        self.contributions = contributions
        self.direction = direction
    def add_intercept(self, val): pass
    def add_baseline(self, val): pass
    def make_final_prediction(self): pass

class _ExplanationModule:
    Explanation = _Explanation
    ExplainerDirection = _ExplainerDirection

e = _ExplanationModule()
...
class BreakDown:
    ...
    def _explain_down (self, observation, baseline, data):
        ...
        target_yhat = float(self.clf.predict(observation).flat[0])
